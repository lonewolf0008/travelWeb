...
const sessionOption = {
  ...
  cookie: {
    ...
    httpOnly: true, // for secret from crosses scripting attacked
  },
};
...
app.all("*", (req, res, next) => {
  next(new ExpressError(404, " 4️⃣0️⃣4️⃣ Page Not Found"));
});
...
app.listen(port, () => console.log(`Server is started port http://localhost:${port}`));
